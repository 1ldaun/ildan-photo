...
export const MainPage = () => {
    ...
    const { currentTab, tabIsLoading } = useAppSelector(state => state.tabsReducer);
    ...
    return (
        <div className={styles.wrapper}>
            <div className={styles.pictureWrapper}>
                <img src={mainEndPoint + pictures[currentTab]?.url} className={cx(styles.picture, tabIsLoading && styles.picture_animation)} alt={pictures[currentTab]?.alt} loading="lazy"/>
